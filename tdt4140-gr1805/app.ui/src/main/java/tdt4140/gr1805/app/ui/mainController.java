...
public class mainController extends Application
{
	...
	public void activateStatisticsScreen() throws Exception
	{
		...
		FXMLLoader statLoader1 = new FXMLLoader(getClass().getResource("StatisticsCitiesMean.fxml"));
		...
		FXMLLoader statLoader2 = new FXMLLoader(getClass().getResource("StatisticsMean.fxml"));
		...
		FXMLLoader statLoader3 = new FXMLLoader(getClass().getResource("StatisticsCitiesMedian.fxml"));
		...
		FXMLLoader statLoader4 = new FXMLLoader(getClass().getResource("StatisticsMedian.fxml"));
